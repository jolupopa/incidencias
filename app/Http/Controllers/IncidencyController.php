...
class IncidencyController extends Controller {
	...
	public function show($id) {
		$incidency = Incident::findOrFail($id);
		$messages = $incidency->messages;
		return view('incidencies.show')->with(compact('incidency', 'messages'));

	}

	public function create() {
		$categories = Category::where('project_id', auth()->user()->selected_project_id)->get();
		return view('incidencies.create')->with(compact('categories'));
	}
	...
	public function edit($id) {
		...
		return view('incidencies.edit')->with(compact('incident', 'categories'));
